		...
		<div class="row mb-5">
			<div class="offset-sm-3 col-sm-9 d-flex align-items-center">
				...
				<div class="confirm-text">
					<strong class="fs-5">Внимание!</strong> Вы уверены, что хотите удалить <strong class="fs-5">участника</strong>?<br>
					Участник будет удален, а также все его обращения.<br>
				</div>
			</div>
		</div>
